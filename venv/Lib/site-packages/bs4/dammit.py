...
try:
    ...
    def chardet_dammit(s):
        return None if isinstance(s, str) else cchardet.detect(s)['encoding']
except ImportError:
    try:
        ...
        import chardet
        def chardet_dammit(s):
            return None if isinstance(s, str) else chardet.detect(s)['encoding']
...
class EncodingDetector:
    ...
    def find_declared_encoding(cls, markup, is_html=False, search_entire_document=False):
        ...
        res = encoding_res[bytes] if isinstance(markup, bytes) else encoding_res[str]
        xml_re = res['xml']
        html_re = res['html']
