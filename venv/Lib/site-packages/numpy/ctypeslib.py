...
if ctypes is None:
    ...
    def load_library(libname, loader_path):
        ...
        if ext := os.path.splitext(libname)[1]:
            libname_ext = [libname]
        ...
        libdir = (
            ...
            else os.path.dirname(loader_path)
        )
...
def ndpointer(dtype=None, ndim=None, shape=None, flags=None):
    ...
    base = _concrete_ndptr if dtype is not None and shape is not None else _ndptr
    klass = type(
        f"ndpointer_{name}",
        (base,),
        {"_dtype_": dtype, "_shape_": shape, "_ndim_": ndim, "_flags_": num},
    )
