...
def _scalar_str(dtype, short):
    ...
    if dtype.type == np.bool_:
        ...
        return "'S'" if _isunsized(dtype) else "'S%d'" % dtype.itemsize
        ...
        return "'V'" if _isunsized(dtype) else "'V%d'" % dtype.itemsize
...
def _struct_dict_str(dtype, includealignedflag):
    ...
    ret = "{'names':[" + ",".join(repr(name) for name in names)
    # Second, the formats
    ret += "], 'formats':["
    ret += ",".join(
