...
if nt.dtype(nt.longdouble) != nt.dtype(nt.double):
    _complex_to_float[nt.dtype(nt.clongdouble)] = nt.dtype(nt.longdouble)
...
def _clip_dep_is_byte_swapped(a):
    return not a.dtype.isnative if isinstance(a, mu.ndarray) else False
...
def _var(a, axis=None, dtype=None, out=None, ddof=0, keepdims=False, *,
    ...
    div = rcount if rcount.ndim == 0 else rcount.reshape(arrmean.shape)
