...
def array2string(a, max_line_width=None, precision=None,
    ...
    return "[]" if a.size == 0 else _array2string(a, options, separator, prefix)
...
def _formatArray(a, format_function, line_width, next_line_prefix,
    ...
    def recurser(index, hanging_indent, curr_width):
        ...
        next_hanging_indent = f'{hanging_indent} '
        next_width = curr_width if legacy == '1.13' else curr_width - len(']')
        a_len = a.shape[axis]
        ...
        if axes_left == 1:
            ...
            if show_summary:
                ...
                line += ", " if legacy == '1.13' else separator
...
class FloatingFormat:
    ...
    def __init__(self, data, precision, floatmode, suppress_small, sign=False,
        ...
        self._legacy = legacy
        if self._legacy == '1.13' and data.shape != () and sign == '-':
            sign = ' '

        self.floatmode = floatmode
        self.precision = None if floatmode == 'unique' else precision
    ...
    def fillFormat(self, data):
        ...
        if len(finite_vals) == 0:
            ...
            self.pad_left = 3 if self._legacy == '1.13' else max(len(s) for s in int_part)
        ...
        if (
            self._legacy != '1.13'
            and self.sign == ' '
            and not any(np.signbit(finite_vals))
        ):
            self.pad_left += 1
...
class _TimelikeFormat:
    ...
    def __call__(self, x):
        return self._nat if isnat(x) else self._format % self._format_non_nat(x)
...
def dtype_is_implied(dtype):
    ...
    return False if dtype.names is not None else dtype.type in _typelessdata
